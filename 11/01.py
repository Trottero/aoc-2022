...
for roun in range(20):
    ...
    for key, monkey in monkeys.items():
        ...
        for item in monkey['items']:
            ...
            monkey_op = monkey_post_operation(monkey_op)
            # Test the result
    ...
    print(f'Round {roun+1}')
    # Print the monkeys inventory
    for key, monkey in monkeys.items():
        print(f'Monkey {key} has {len(monkey["items"])} items: {monkey["items"]}')
